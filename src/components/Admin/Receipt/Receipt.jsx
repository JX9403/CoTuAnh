      ...
      render: (_, record) => (
        <Space size="middle">
          <Button
            ...
            disabled={record.status === "Đã xác nhận"}
            style={{ color: "#000" , border:'none', backgroundColor:'transparent'
            }}
          />
        ...
        .then((jsonData) => {
          ...
          if (Array.isArray(jsonData.ReceiptDetail)) {
            ...
            setSelectedProductsData(
              inventoryWithStatus.map((item) => item.product_id)
            );
          }
        ...
        <Flex justify="space-between" className="mb-3">
          ...
          <Card style={{ width: "calc(30% - 20px)", borderColor: "#A4A4A4" }}>
            ...
            <Form.Item
              label="Ngày giao"
              name="delivery_date"
              initialValue={moment(editData.delivery_date)}
            >
              <DatePicker disabled style={{ width: "100%" }} />
            </Form.Item>
            <Form.Item label="Trạng thái " name="status">
